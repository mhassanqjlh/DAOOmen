 ...
 * This file demonstrates how to integrate Daoomen with a web frontend
 */

// For React/Vue/Angular applications
export class DaoomenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DaoomenClient(provider, contractAddress);
